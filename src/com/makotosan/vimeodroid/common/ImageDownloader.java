...
public class ImageDownloader {
	...
	private ApplicationEx app = null;

	public ImageDownloader(ApplicationEx app) {
		this.app = app;
	}
	...
	Bitmap downloadBitmap(String url) {
		...
		HttpClient client = new DefaultHttpClient(); // app.getHttpClient();
		...
		try {
			...
			if (entity != null) {
				...
				try {
					...
					return addBitmapToStorage(url, inputStream);
	...
	private final HashMap<String, Bitmap> sHardBitmapCache = new LinkedHashMap<String, Bitmap>(HARD_CACHE_CAPACITY / 2, 0.75f, true) {
		 ...
		 * 
		 */
		private static final long serialVersionUID = 1833581133570704751L;
